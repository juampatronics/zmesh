...
private:
    ...
    static void* ENTRY(void* info)
    {
        ...
        t_->on_before_start(win32::GetCurrentThreadId(),
...
public:
    ...
    void start(bool detached = false)
    {
        ...
        win32::handle h = win32::CreateThread(
            NULL, 0, (LPTHREAD_START_ROUTINE)ENTRY, (LPVOID)(t_.get()), 0, &id);
    ...
    bool join() { return t_->join(); }

    void wake() { t_->wake(); }

    void detach() { t_->detach(); }

    thread_id_type get_id() { return t_->get_id(); }
};
