...
public:
    ...
    template <class P1>
    explicit periodic_function(bool (*f)(P1), const P1& p1, int64_t to)
        : f_(new periodic_function_adapter(bind(f, p1), to))
    {
    }

    template <class P1, class P2>
    explicit periodic_function(bool (*f)(P1, P2), const P1& p1, const P2& p2,
                               int64_t to)
    ...
    explicit periodic_function(bool (*f)(P1, P2, P3), const P1& p1,
                               const P2& p2, const P3& p3, int64_t to)
        : f_(new periodic_function_adapter(bind(f, p1, p2, p3), to))
    {
    }

    template <class P1, class P2, class P3, class P4>
    explicit periodic_function(bool (*f)(P1, P2, P3, P4), const P1& p1,
    ...
    explicit periodic_function(bool (*f)(P1, P2, P3, P4, P5), const P1& p1,
                               const P2& p2, const P3& p3, const P4& p4,
    ...
    explicit periodic_function(bool (*f)(P1, P2, P3, P4, P5, P6), const P1& p1,
                               const P2& p2, const P3& p3, const P4& p4,
    ...
    explicit periodic_function(bool (*f)(P1, P2, P3, P4, P5, P6, P7),
                               ...
                               const P7& p7, int64_t to)
        : f_(new periodic_function_adapter(bind(f, p1, p2, p3, p4, p5, p6, p7),
                                           to))
    {
    }
    ...
    explicit periodic_function(bool (*f)(P1, P2, P3, P4, P5, P6, P7, P8),
                               const P1& p1, const P2& p2, const P3& p3,
                               const P4& p4, const P5& p5, const P6& p6,
                               const P7& p7, const P8& p8, int64_t to)
        : f_(new periodic_function_adapter(
              bind(f, p1, p2, p3, p4, p5, p6, p7, p8), to))
    {
    }
    ...
    explicit periodic_function(bool (*f)(P1), const P1& p1,
                               const interval::detail::interval_tpl<I>& itv)
    ...
    explicit periodic_function(bool (*f)(P1, P2, P3, P4), const P1& p1,
                               const P2& p2, const P3& p3, const P4& p4,
                               const interval::detail::interval_tpl<I>& itv)
        : f_(new periodic_function_adapter(bind(f, p1, p2, p3, p4),
                                           itv.msecs()))
    {
    }

    template <class P1, class P2, class P3, class P4, class P5, int64_t I>
    explicit periodic_function(bool (*f)(P1, P2, P3, P4, P5), const P1& p1,
                               const P2& p2, const P3& p3, const P4& p4,
                               const P5&                                p5,
                               const interval::detail::interval_tpl<I>& itv)
        : f_(new periodic_function_adapter(bind(f, p1, p2, p3, p4, p5),
                                           itv.msecs()))
    {
    }
    ...
    explicit periodic_function(bool (*f)(P1, P2, P3, P4, P5, P6), const P1& p1,
                               ...
                               const interval::detail::interval_tpl<I>& itv)
        : f_(new periodic_function_adapter(bind(f, p1, p2, p3, p4, p5, p6),
                                           itv.msecs()))
    {
    }
    ...
    template <class P1, class P2, class P3, class P4, class P5, class P6,
              class P7, class P8, int64_t I>
    explicit periodic_function(
        const function<bool(P1, P2, P3, P4, P5, P6, P7, P8)>& f, const P1& p1,
        const P2& p2, const P3& p3, const P4& p4, const P5& p5, const P6& p6,
        const P7& p7, const P8& p8,
        const interval::detail::interval_tpl<I>& itv)
        : f_(new periodic_function_adapter(
              bind(f, p1, p2, p3, p4, p5, p6, p7, p8), itv.msecs()))
    {
    }
    ...
    explicit periodic_function(bool (T::*f)(P1), T* t, const P1& p1, int64_t to)
        : f_(new periodic_function_adapter(bind(f, t, p1), to))
    {
    }

    template <class T, class P1, class P2>
    explicit periodic_function(bool (T::*f)(P1, P2), T* t, const P1& p1,
                               const P2& p2, int64_t to)
        : f_(new periodic_function_adapter(bind(f, t, p1, p2), to))
    {
    }

    template <class T, class P1, class P2, class P3>
    explicit periodic_function(bool (T::*f)(P1, P2, P3), T* t, const P1& p1,
                               const P2& p2, const P3& p3, int64_t to)
    ...
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4), T* t, const P1& p1,
                               const P2& p2, const P3& p3, const P4& p4,
                               int64_t to)
    ...
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4, P5), T* t,
                               const P1& p1, const P2& p2, const P3& p3,
                               const P4& p4, const P5& p5, int64_t to)
    ...
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4, P5, P6), T* t,
                               ...
                               const P4& p4, const P5& p5, const P6& p6,
                               int64_t to)
        : f_(new periodic_function_adapter(bind(f, t, p1, p2, p3, p4, p5, p6),
                                           to))
    {
    }
    ...
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4, P5, P6, P7), T* t,
                               ...
                               const P7& p7, int64_t to)
        : f_(new periodic_function_adapter(
              bind(f, t, p1, p2, p3, p4, p5, p6, p7), to))
    {
    }

    template <class T, class P1, class P2, class P3, class P4, class P5,
              class P6, class P7, class P8>
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4, P5, P6, P7, P8),
                               T* t, const P1& p1, const P2& p2, const P3& p3,
                               const P4& p4, const P5& p5, const P6& p6,
                               const P7& p7, const P8& p8, int64_t to)
        : f_(new periodic_function_adapter(
              bind(f, t, p1, p2, p3, p4, p5, p6, p7, p8), to))
    {
    }
    ...
    explicit periodic_function(bool (T::*f)(P1), T* t, const P1& p1,
                               const interval::detail::interval_tpl<I>& itv)
    ...
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4), T* t, const P1& p1,
                               const P2& p2, const P3& p3, const P4& p4,
                               const interval::detail::interval_tpl<I>& itv)
        : f_(new periodic_function_adapter(bind(f, t, p1, p2, p3, p4),
                                           itv.msecs()))
    {
    }
    ...
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4, P5), T* t,
                               ...
                               const interval::detail::interval_tpl<I>& itv)
        : f_(new periodic_function_adapter(bind(f, t, p1, p2, p3, p4, p5),
                                           itv.msecs()))
    {
    }
    ...
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4, P5, P6, P7), T* t,
                               ...
                               const interval::detail::interval_tpl<I>& itv)
        : f_(new periodic_function_adapter(
              bind(f, t, p1, p2, p3, p4, p5, p6, p7), itv.msecs()))
    {
    }

    template <class T, class P1, class P2, class P3, class P4, class P5,
              class P6, class P7, class P8, int64_t I>
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4, P5, P6, P7, P8),
                               T* t, const P1& p1, const P2& p2, const P3& p3,
                               const P4& p4, const P5& p5, const P6& p6,
                               const P7& p7, const P8& p8,
                               const interval::detail::interval_tpl<I>& itv)
        : f_(new periodic_function_adapter(
              bind(f, t, p1, p2, p3, p4, p5, p6, p7, p8), itv.msecs()))
    {
    }
    ...
    template <class T, class P1>
    explicit periodic_function(bool (T::*f)(P1) const, const T* t, const P1& p1,
                               int64_t to)
        : f_(new periodic_function_adapter(bind(f, t, p1), to))
    {
    }
    ...
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4) const, const T* t,
                               const P1& p1, const P2& p2, const P3& p3,
                               const P4& p4, int64_t to)
        : f_(new periodic_function_adapter(bind(f, t, p1, p2, p3, p4), to))
    {
    }

    template <class T, class P1, class P2, class P3, class P4, class P5>
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4, P5) const,
                               const T* t, const P1& p1, const P2& p2,
    ...
    template <class T, class P1, class P2, class P3, class P4, class P5,
              class P6>
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4, P5, P6) const,
                               const T* t, const P1& p1, const P2& p2,
                               const P3& p3, const P4& p4, const P5& p5,
                               const P6& p6, int64_t to)
        : f_(new periodic_function_adapter(bind(f, t, p1, p2, p3, p4, p5, p6),
                                           to))
    {
    }
    ...
    template <class T, class P1, class P2, class P3, class P4, class P5,
              class P6, class P7>
    explicit periodic_function(bool (T::*f)(P1, P2, P3, P4, P5, P6, P7) const,
                               const T* t, const P1& p1, const P2& p2,
                               const P3& p3, const P4& p4, const P5& p5,
                               const P6& p6, const P7& p7, int64_t to)
        : f_(new periodic_function_adapter(
              bind(f, t, p1, p2, p3, p4, p5, p6, p7), to))
    {
    }
    ...
    std::size_t cycles() const { return f_->cycles(); }

    void timeout(int64_t msecs_timeout) { f_->timeout(msecs_timeout); }

    int64_t timeout() const { return f_->timeout(); }
    ...
    operator shared_ptr<runnable>() const { return f_; }
};
