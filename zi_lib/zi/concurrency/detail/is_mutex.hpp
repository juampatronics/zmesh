...
{
    static const bool value =
        has_member_fn_lock<T>::value && has_member_fn_unlock<T>::value;
};

template <class T>
struct is_rwmutex
{
    static const bool value = has_member_fn_acquire_read<T>::value &&
