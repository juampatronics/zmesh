...
private:
    ...
    interval_tpl(int64_t v, void* distinguish_constructor)
        : value_(v)
    {
    }
...
public:
    ...
    explicit interval_tpl(int64_t v)
        : value_(Factor * v)
    {
    }
    ...
    interval_tpl operator-() const { return interval_tpl(value_, 0); }
    ...
    interval_tpl operator*(int64_t v) { return interval_tpl(value_ * v, 0); }
...
#    undef INTERVAL_TPL_DEFINE_FRIEND_BOOL_BINARY_OPERATOR
    ...
    int64_t nsecs() const { return value_; }

    int64_t nanoseconds() const { return value_; }
...
#    define ZI_TIME_DEFINE_TIME_INTERVAL_TYPE(len, name1, name2)               \
        ...
        template <>                                                            \
        struct is_time_interval<name1> : true_type                             \
        {                                                                      \
        }
...
ZI_TIME_DEFINE_TIME_INTERVAL_TYPE(3600000000000LL, hours,
                                  ___dummy_name_for_hours);
ZI_TIME_DEFINE_TIME_INTERVAL_TYPE(86400000000000LL, days,
                                  ___dummy_name_for_days);
