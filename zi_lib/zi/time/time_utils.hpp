...
inline int64_t ft_to_msec(FILETIME& ft)
{
    ...
    return static_cast<int64_t>(t.QuadPart - (116444736000000000ULL)) /
           10000ULL;
}
...
inline int64_t ft_to_usec(FILETIME& ft)
{
    ...
    return static_cast<int64_t>(t.QuadPart - (116444736000000000ULL)) / 10ULL;
}
...
inline int64_t ft_to_nsec(FILETIME& ft)
{
    ...
    return static_cast<int64_t>(t.QuadPart - (116444736000000000ULL)) * 100ULL;
}
...
{
    return static_cast<int64_t>(tv.tv_sec) * 1000000000LL + tv.tv_usec * 1000LL;
}
