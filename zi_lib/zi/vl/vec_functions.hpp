...
inline typename detail::promote<T>::type squared_length(const vec<T, N>& v)
{
...
template <class T, std::size_t N>
inline typename detail::promote<T>::type sqrlen(const vec<T, N>& v)
{
    typedef typename detail::promote<T>::type promoted_type;
    promoted_type                             r = static_cast<promoted_type>(0);
    for (std::size_t i = 0; i < N; ++i)
...
template <class T, std::size_t N>
inline typename detail::promote<T>::type length(const vec<T, N>& v)
{
    return std::sqrt(sqrlen(v));
}

template <class T, std::size_t N>
inline typename detail::promote<T>::type len(const vec<T, N>& v)
{
    return std::sqrt(sqrlen(v));
}

template <class T, std::size_t N>
inline typename detail::enable_if<is_floating_point<T>, T>::type
normalize(vec<T, N>& v)
{
...
template <class T, std::size_t N>
inline vec<typename detail::promote<T>::type, N> norm(const vec<T, N>& v)
{
...
inline typename detail::promote<T, O>::type
...
template <class T, std::size_t N>
inline typename detail::promote<T>::type squared_distance(const vec<T, N>& v1,
                                                          const vec<T, N>& v2)
{
    typedef typename detail::promote<T>::type promoted_type;
    promoted_type                             r = static_cast<promoted_type>(0);
...
template <class T, class O, std::size_t N>
inline typename detail::promote<T, O>::type distance(const vec<T, N>& v1,
                                                     const vec<O, N>& v2)
{
...
template <class T, std::size_t N>
inline typename detail::promote<T>::type distance(const vec<T, N>& v1,
                                                  const vec<T, N>& v2)
{
    return std::sqrt(squared_distance(v1, v2));
}
...
template <class T, std::size_t N>
inline void clamp(vec<T, N>& v, const T& min = T(0), const T& max = T(1))
{
    for (std::size_t i = 0; i < N; ++i)
    {
...
template <class T>
inline typename detail::enable_if<is_signed<T>, vec<T, 2>>::type
...
template <class T>
inline typename detail::enable_if<is_signed<T>, vec<T, 3>>::type
...
inline vec<typename detail::promote<T, O>::type, 3> cross(const vec<T, 3>& v1,
                                                          const vec<O, 3>& v2)
{
    typedef typename detail::promote<T>::type promoted_type;
    vec<promoted_type, 3>                     res;

    res[0] = static_cast<promoted_type>(v1[1]) * v2[2] -
             static_cast<promoted_type>(v1[2]) * v2[1];

    res[1] = static_cast<promoted_type>(v1[2]) * v2[0] -
             static_cast<promoted_type>(v1[0]) * v2[2];

    res[2] = static_cast<promoted_type>(v1[0]) * v2[1] -
...
inline vec<typename detail::promote<T, O, W>::type, 4>
...
template <class T, class O, std::size_t N>
inline typename detail::promote<T, O>::type dot(const vec<T, N>& v1,
                                                const vec<O, N>& v2)
{
    typedef typename detail::promote<T, O>::type promoted_type;
    promoted_type r = static_cast<promoted_type>(0);
...
template <class T, std::size_t N>
inline typename detail::promote<T>::type dot(const vec<T, N>& v1,
                                             const vec<T, N>& v2)
{
    typedef typename detail::promote<T>::type promoted_type;
    promoted_type                             r = static_cast<promoted_type>(0);
...
inline vec<typename detail::promote<X, Y, Z>::type, N>
...
template <class T, std::size_t N>
inline vec<typename detail::promote<T>::type, N>
...
template <class T, class O, std::size_t N>
inline vec<typename detail::promote<T, O>::type, N>
...
#    define ZI_VL_INNER_PRODUCT_IMPL(name)                                     \
                                                                               \
        template <class T, class O, std::size_t N>                             \
        inline vec<typename detail::promote<T, O>::type, N> name(              \
            const vec<T, N>& v1, const vec<O, N>& v2)                          \
        {                                                                      \
            typedef typename detail::promote<T, O>::type promoted_type;        \
            ...
            for (std::size_t i = 0; i < N; ++i)                                \
            {                                                                  \
                res.at(i) = static_cast<promoted_type>(v1.at(i)) * v2.at(i);   \
            }                                                                  \
            return res;                                                        \
        }                                                                      \
                                                                               \
        template <class T, std::size_t N>                                      \
        inline vec<T, N> name(const vec<T, N>& v1, const vec<T, N>& v2)        \
        {                                                                      \
            vec<T, N> res;                                                     \
                                                                               \
            for (std::size_t i = 0; i < N; ++i)                                \
...
inline typename detail::enable_if<is_scalar<X>, vec<typename detail::promote<T, X>::type, N + 1>>::type operator,(
    const vec<T, N>& vl, const X& v)
{
...
template <class T, std::size_t N>
inline vec<T, N + 1> operator,(const vec<T, N>& vl, const T& v)
{
...
template <class T, std::size_t N>
inline vec<T, N + 1> operator,(const T& v, const vec<T, N>& vr)
{
    return vec<T, N + 1>(v, vr);
}

template <class X, std::size_t N, class T, std::size_t M>
inline vec<typename detail::promote<T, X>::type, N + M>
...
inline vec<T, N + M> operator,(const vec<T, N>& vl, const vec<T, M>& vr)
{
