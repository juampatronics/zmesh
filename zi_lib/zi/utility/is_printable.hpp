...
template <class Type>
struct is_printable_helper<Type, sizeof(std::ostream)>
{
...
struct is_printable
    : is_printable_helper<
          Type, sizeof(detail::get_instance<std::ostream>::static_reference
...
template <>
struct is_printable<const volatile void>
    : is_printable_helper<const volatile void, 0>
{
};
