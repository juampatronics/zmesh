...
ZI_GLAPI void ZI_GLAPI_ENTRY glClearColor(gl_clampf red, gl_clampf green,
                                          gl_clampf blue, gl_clampf alpha);
ZI_GLAPI void ZI_GLAPI_ENTRY glClear(gl_bitfield mask);
ZI_GLAPI void ZI_GLAPI_ENTRY glIndexMask(gl_uint mask);
ZI_GLAPI void ZI_GLAPI_ENTRY glColorMask(gl_boolean red, gl_boolean green,
                                         gl_boolean blue, gl_boolean alpha);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glScissor(gl_int x, gl_int y, gl_sizei width,
                                       gl_sizei height);
ZI_GLAPI void ZI_GLAPI_ENTRY glClipPlane(gl_enum          plane,
                                         const gl_double* equation);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glDepthRange(gl_clampd near_val,
                                          gl_clampd far_val);

/*
 * Accumulation Buffer
 */
ZI_GLAPI void ZI_GLAPI_ENTRY glClearAccum(gl_float red, gl_float green,
                                          gl_float blue, gl_float alpha);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glOrtho(gl_double left, gl_double right,
                                     gl_double bottom, gl_double top,
                                     gl_double near_val, gl_double far_val);
ZI_GLAPI void ZI_GLAPI_ENTRY glFrustum(gl_double left, gl_double right,
                                       gl_double bottom, gl_double top,
                                       gl_double near_val, gl_double far_val);
ZI_GLAPI void ZI_GLAPI_ENTRY glViewport(gl_int x, gl_int y, gl_sizei width,
                                        gl_sizei height);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glRotated(gl_double angle, gl_double x,
                                       gl_double y, gl_double z);
ZI_GLAPI void ZI_GLAPI_ENTRY glRotatef(gl_float angle, gl_float x, gl_float y,
                                       gl_float z);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glTranslated(gl_double x, gl_double y,
                                          gl_double z);
...
ZI_GLAPI void ZI_GLAPI_ENTRY       glCallLists(gl_sizei n, gl_enum type,
                                               const gl_void* lists);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glVertex4d(gl_double x, gl_double y, gl_double z,
                                        gl_double w);
ZI_GLAPI void ZI_GLAPI_ENTRY glVertex4f(gl_float x, gl_float y, gl_float z,
                                        gl_float w);
ZI_GLAPI void ZI_GLAPI_ENTRY glVertex4i(gl_int x, gl_int y, gl_int z, gl_int w);
ZI_GLAPI void ZI_GLAPI_ENTRY glVertex4s(gl_short x, gl_short y, gl_short z,
                                        gl_short w);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glNormal3d(gl_double nx, gl_double ny,
                                        gl_double nz);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glColor3b(gl_byte red, gl_byte green,
                                       gl_byte blue);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor3d(gl_double red, gl_double green,
                                       gl_double blue);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor3f(gl_float red, gl_float green,
                                       gl_float blue);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor3i(gl_int red, gl_int green, gl_int blue);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor3s(gl_short red, gl_short green,
                                       gl_short blue);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor3ub(gl_ubyte red, gl_ubyte green,
                                        gl_ubyte blue);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor3ui(gl_uint red, gl_uint green,
                                        gl_uint blue);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor3us(gl_ushort red, gl_ushort green,
                                        gl_ushort blue);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor4b(gl_byte red, gl_byte green, gl_byte blue,
                                       gl_byte alpha);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor4d(gl_double red, gl_double green,
                                       gl_double blue, gl_double alpha);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor4f(gl_float red, gl_float green,
                                       gl_float blue, gl_float alpha);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor4i(gl_int red, gl_int green, gl_int blue,
                                       gl_int alpha);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor4s(gl_short red, gl_short green,
                                       gl_short blue, gl_short alpha);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor4ub(gl_ubyte red, gl_ubyte green,
                                        gl_ubyte blue, gl_ubyte alpha);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor4ui(gl_uint red, gl_uint green,
                                        gl_uint blue, gl_uint alpha);
ZI_GLAPI void ZI_GLAPI_ENTRY glColor4us(gl_ushort red, gl_ushort green,
                                        gl_ushort blue, gl_ushort alpha);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glTexCoord3d(gl_double s, gl_double t,
                                          gl_double r);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glTexCoord4d(gl_double s, gl_double t, gl_double r,
                                          gl_double q);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexCoord4f(gl_float s, gl_float t, gl_float r,
                                          gl_float q);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexCoord4i(gl_int s, gl_int t, gl_int r,
                                          gl_int q);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexCoord4s(gl_short s, gl_short t, gl_short r,
                                          gl_short q);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glRasterPos3d(gl_double x, gl_double y,
                                           gl_double z);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glRasterPos4d(gl_double x, gl_double y,
                                           gl_double z, gl_double w);
ZI_GLAPI void ZI_GLAPI_ENTRY glRasterPos4f(gl_float x, gl_float y, gl_float z,
                                           gl_float w);
ZI_GLAPI void ZI_GLAPI_ENTRY glRasterPos4i(gl_int x, gl_int y, gl_int z,
                                           gl_int w);
ZI_GLAPI void ZI_GLAPI_ENTRY glRasterPos4s(gl_short x, gl_short y, gl_short z,
                                           gl_short w);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glRectd(gl_double x1, gl_double y1, gl_double x2,
                                     gl_double y2);
ZI_GLAPI void ZI_GLAPI_ENTRY glRectf(gl_float x1, gl_float y1, gl_float x2,
                                     gl_float y2);
ZI_GLAPI void ZI_GLAPI_ENTRY glRecti(gl_int x1, gl_int y1, gl_int x2,
                                     gl_int y2);
ZI_GLAPI void ZI_GLAPI_ENTRY glRects(gl_short x1, gl_short y1, gl_short x2,
                                     gl_short y2);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glLightf(gl_enum light, gl_enum pname,
                                      gl_float param);
ZI_GLAPI void ZI_GLAPI_ENTRY glLighti(gl_enum light, gl_enum pname,
                                      gl_int param);
ZI_GLAPI void ZI_GLAPI_ENTRY glLightfv(gl_enum light, gl_enum pname,
                                       const gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glLightiv(gl_enum light, gl_enum pname,
                                       const gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetLightfv(gl_enum light, gl_enum pname,
                                          gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetLightiv(gl_enum light, gl_enum pname,
                                          gl_int* params);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glLightModelfv(gl_enum         pname,
                                            const gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glLightModeliv(gl_enum       pname,
                                            const gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glMaterialf(gl_enum face, gl_enum pname,
                                         gl_float param);
ZI_GLAPI void ZI_GLAPI_ENTRY glMateriali(gl_enum face, gl_enum pname,
                                         gl_int param);
ZI_GLAPI void ZI_GLAPI_ENTRY glMaterialfv(gl_enum face, gl_enum pname,
                                          const gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glMaterialiv(gl_enum face, gl_enum pname,
                                          const gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetMaterialfv(gl_enum face, gl_enum pname,
                                             gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetMaterialiv(gl_enum face, gl_enum pname,
                                             gl_int* params);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glPixelMapfv(gl_enum map, gl_sizei mapsize,
                                          const gl_float* values);
ZI_GLAPI void ZI_GLAPI_ENTRY glPixelMapuiv(gl_enum map, gl_sizei mapsize,
                                           const gl_uint* values);
ZI_GLAPI void ZI_GLAPI_ENTRY glPixelMapusv(gl_enum map, gl_sizei mapsize,
                                           const gl_ushort* values);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glBitmap(gl_sizei width, gl_sizei height,
                                      gl_float xorig, gl_float yorig,
                                      gl_float xmove, gl_float ymove,
                                      const gl_ubyte* bitmap);
ZI_GLAPI void ZI_GLAPI_ENTRY glReadPixels(gl_int x, gl_int y, gl_sizei width,
                                          gl_sizei height, gl_enum format,
                                          gl_enum type, gl_void* pixels);
ZI_GLAPI void ZI_GLAPI_ENTRY glDrawPixels(gl_sizei width, gl_sizei height,
                                          gl_enum format, gl_enum type,
                                          const gl_void* pixels);
ZI_GLAPI void ZI_GLAPI_ENTRY glCopyPixels(gl_int x, gl_int y, gl_sizei width,
                                          gl_sizei height, gl_enum type);

/*
 * Stenciling
 */
ZI_GLAPI void ZI_GLAPI_ENTRY glStencilFunc(gl_enum func, gl_int ref,
                                           gl_uint mask);
ZI_GLAPI void ZI_GLAPI_ENTRY glStencilMask(gl_uint mask);
ZI_GLAPI void ZI_GLAPI_ENTRY glStencilOp(gl_enum fail, gl_enum zfail,
                                         gl_enum zpass);
 ...
 * Texture mapping
 */
ZI_GLAPI void ZI_GLAPI_ENTRY glTexGend(gl_enum coord, gl_enum pname,
                                       gl_double param);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexGenf(gl_enum coord, gl_enum pname,
                                       gl_float param);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexGeni(gl_enum coord, gl_enum pname,
                                       gl_int param);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexGendv(gl_enum coord, gl_enum pname,
                                        const gl_double* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexGenfv(gl_enum coord, gl_enum pname,
                                        const gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexGeniv(gl_enum coord, gl_enum pname,
                                        const gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetTexGendv(gl_enum coord, gl_enum pname,
                                           gl_double* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetTexGenfv(gl_enum coord, gl_enum pname,
                                           gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetTexGeniv(gl_enum coord, gl_enum pname,
                                           gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexEnvf(gl_enum target, gl_enum pname,
                                       gl_float param);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexEnvi(gl_enum target, gl_enum pname,
                                       gl_int param);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexEnvfv(gl_enum target, gl_enum pname,
                                        const gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexEnviv(gl_enum target, gl_enum pname,
                                        const gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetTexEnvfv(gl_enum target, gl_enum pname,
                                           gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetTexEnviv(gl_enum target, gl_enum pname,
                                           gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexParameterf(gl_enum target, gl_enum pname,
                                             gl_float param);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexParameteri(gl_enum target, gl_enum pname,
                                             gl_int param);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexParameterfv(gl_enum target, gl_enum pname,
                                              const gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexParameteriv(gl_enum target, gl_enum pname,
                                              const gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetTexParameterfv(gl_enum target, gl_enum pname,
                                                 gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetTexParameteriv(gl_enum target, gl_enum pname,
                                                 gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetTexLevelParameterfv(gl_enum   target,
                                                      gl_int    level,
                                                      gl_enum   pname,
                                                      gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetTexLevelParameteriv(gl_enum target,
                                                      gl_int  level,
                                                      gl_enum pname,
                                                      gl_int* params);

ZI_GLAPI void ZI_GLAPI_ENTRY glTexImage1D(gl_enum target, gl_int level,
                                          gl_int internalFormat, gl_sizei width,
                                          gl_int border, gl_enum format,
                                          gl_enum type, const gl_void* pixels);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexImage2D(gl_enum target, gl_int level,
                                          gl_int internalFormat, gl_sizei width,
                                          gl_sizei height, gl_int border,
                                          gl_enum format, gl_enum type,
                                          const gl_void* pixels);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetTexImage(gl_enum target, gl_int level,
                                           gl_enum format, gl_enum type,
                                           gl_void* pixels);
 ...
 * Evaluators
 */
ZI_GLAPI void ZI_GLAPI_ENTRY glMap1d(gl_enum target, gl_double u1, gl_double u2,
                                     gl_int stride, gl_int order,
                                     const gl_double* points);
ZI_GLAPI void ZI_GLAPI_ENTRY glMap1f(gl_enum target, gl_float u1, gl_float u2,
                                     gl_int stride, gl_int order,
                                     const gl_float* points);
ZI_GLAPI void ZI_GLAPI_ENTRY glMap2d(gl_enum target, gl_double u1, gl_double u2,
                                     gl_int ustride, gl_int uorder,
                                     gl_double v1, gl_double v2, gl_int vstride,
                                     gl_int vorder, const gl_double* points);
ZI_GLAPI void ZI_GLAPI_ENTRY glMap2f(gl_enum target, gl_float u1, gl_float u2,
                                     gl_int ustride, gl_int uorder, gl_float v1,
                                     gl_float v2, gl_int vstride, gl_int vorder,
                                     const gl_float* points);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetMapdv(gl_enum target, gl_enum query,
                                        gl_double* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetMapfv(gl_enum target, gl_enum query,
                                        gl_float* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetMapiv(gl_enum target, gl_enum query,
                                        gl_int* v);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glMapGrid2d(gl_int un, gl_double u1, gl_double u2,
                                         gl_int vn, gl_double v1, gl_double v2);
ZI_GLAPI void ZI_GLAPI_ENTRY glMapGrid2f(gl_int un, gl_float u1, gl_float u2,
                                         gl_int vn, gl_float v1, gl_float v2);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glEvalMesh2(gl_enum mode, gl_int i1, gl_int i2,
                                         gl_int j1, gl_int j2);
 ...
 */
ZI_GLAPI void ZI_GLAPI_ENTRY glFeedbackBuffer(gl_sizei size, gl_enum type,
                                              gl_float* buffer);
