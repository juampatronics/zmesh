...
ZI_GLAPI int ZI_GLAPI_ENTRY  glutCreateSubWindow(int window, int x, int y,
...
ZI_GLAPI void ZI_GLAPI_ENTRY glutChangeToMenuEntry(int item, const char* label,
                                                   int value);
ZI_GLAPI void ZI_GLAPI_ENTRY glutChangeToSubMenu(int item, const char* label,
                                                 int value);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glutTimerFunc(unsigned int time,
                                           void (*callback)(int), int value);
ZI_GLAPI void ZI_GLAPI_ENTRY glutIdleFunc(void (*callback)(void));
ZI_GLAPI void ZI_GLAPI_ENTRY glutKeyboardFunc(void (*callback)(unsigned char,
                                                               int, int));
...
ZI_GLAPI void ZI_GLAPI_ENTRY glutMouseFunc(void (*callback)(int, int, int,
                                                            int));
...
ZI_GLAPI void ZI_GLAPI_ENTRY glutKeyboardUpFunc(void (*callback)(unsigned char,
                                                                 int, int));
ZI_GLAPI void ZI_GLAPI_ENTRY glutSpecialUpFunc(void (*callback)(int, int, int));
ZI_GLAPI void ZI_GLAPI_ENTRY glutJoystickFunc(void (*callback)(unsigned int,
                                                               int, int, int),
                                              int pollInterval);
ZI_GLAPI void ZI_GLAPI_ENTRY glutMenuStateFunc(void (*callback)(int));
ZI_GLAPI void ZI_GLAPI_ENTRY glutMenuStatusFunc(void (*callback)(int, int,
                                                                 int));
...
ZI_GLAPI void ZI_GLAPI_ENTRY glutSpaceballMotionFunc(void (*callback)(int, int,
                                                                      int));
ZI_GLAPI void ZI_GLAPI_ENTRY glutSpaceballRotateFunc(void (*callback)(int, int,
                                                                      int));
ZI_GLAPI void ZI_GLAPI_ENTRY glutSpaceballButtonFunc(void (*callback)(int,
                                                                      int));
...
ZI_GLAPI void ZI_GLAPI_ENTRY glutTabletButtonFunc(void (*callback)(int, int,
                                                                   int, int));
...
ZI_GLAPI int ZI_GLAPI_ENTRY  glutBitmapLength(void*                font,
                                              const unsigned char* string);
ZI_GLAPI int ZI_GLAPI_ENTRY  glutStrokeLength(void*                font,
                                              const unsigned char* string);
ZI_GLAPI void ZI_GLAPI_ENTRY glutWireCube(gl_double size);
ZI_GLAPI void ZI_GLAPI_ENTRY glutSolidCube(gl_double size);
ZI_GLAPI void ZI_GLAPI_ENTRY glutWireSphere(gl_double radius, gl_int slices,
                                            gl_int stacks);
ZI_GLAPI void ZI_GLAPI_ENTRY glutSolidSphere(gl_double radius, gl_int slices,
                                             gl_int stacks);
ZI_GLAPI void ZI_GLAPI_ENTRY glutWireCone(gl_double base, gl_double height,
                                          gl_int slices, gl_int stacks);
ZI_GLAPI void ZI_GLAPI_ENTRY glutSolidCone(gl_double base, gl_double height,
                                           gl_int slices, gl_int stacks);
ZI_GLAPI void ZI_GLAPI_ENTRY glutWireTorus(gl_double innerRadius,
                                           gl_double outerRadius, gl_int sides,
                                           gl_int rings);
ZI_GLAPI void ZI_GLAPI_ENTRY glutSolidTorus(gl_double innerRadius,
                                            gl_double outerRadius, gl_int sides,
                                            gl_int rings);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glutVideoResize(int x, int y, int width,
                                             int height);
ZI_GLAPI void ZI_GLAPI_ENTRY glutVideoPan(int x, int y, int width, int height);
ZI_GLAPI void ZI_GLAPI_ENTRY glutSetColor(int color, gl_float red,
                                          gl_float green, gl_float blue);
