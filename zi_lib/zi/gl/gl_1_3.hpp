...
ZI_GLAPI void ZI_GLAPI_ENTRY glCompressedTexImage1D(
    gl_enum target, gl_int level, gl_enum internalformat, gl_sizei width,
    gl_int border, gl_sizei imageSize, const gl_void* data);
ZI_GLAPI void ZI_GLAPI_ENTRY glCompressedTexImage2D(
    gl_enum target, gl_int level, gl_enum internalformat, gl_sizei width,
    gl_sizei height, gl_int border, gl_sizei imageSize, const gl_void* data);
ZI_GLAPI void ZI_GLAPI_ENTRY
glCompressedTexImage3D(gl_enum target, gl_int level, gl_enum internalformat,
                       gl_sizei width, gl_sizei height, gl_sizei depth,
                       gl_int border, gl_sizei imageSize, const gl_void* data);
ZI_GLAPI void ZI_GLAPI_ENTRY glCompressedTexSubImage1D(
    gl_enum target, gl_int level, gl_int xoffset, gl_sizei width,
    gl_enum format, gl_sizei imageSize, const gl_void* data);
ZI_GLAPI void ZI_GLAPI_ENTRY glCompressedTexSubImage2D(
    gl_enum target, gl_int level, gl_int xoffset, gl_int yoffset,
    gl_sizei width, gl_sizei height, gl_enum format, gl_sizei imageSize,
    const gl_void* data);
ZI_GLAPI void ZI_GLAPI_ENTRY glCompressedTexSubImage3D(
    gl_enum target, gl_int level, gl_int xoffset, gl_int yoffset,
    gl_int zoffset, gl_sizei width, gl_sizei height, gl_sizei depth,
    gl_enum format, gl_sizei imageSize, const gl_void* data);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetCompressedTexImage(gl_enum target, gl_int lod,
                                                     gl_void* img);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord1d(gl_enum target, gl_double s);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord1dv(gl_enum          target,
                                                const gl_double* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord1f(gl_enum target, gl_float s);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord1fv(gl_enum         target,
                                                const gl_float* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord1i(gl_enum target, gl_int s);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord1iv(gl_enum       target,
                                                const gl_int* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord1s(gl_enum target, gl_short s);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord1sv(gl_enum         target,
                                                const gl_short* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord2d(gl_enum target, gl_double s,
                                               gl_double t);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord2dv(gl_enum          target,
                                                const gl_double* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord2f(gl_enum target, gl_float s,
                                               gl_float t);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord2fv(gl_enum         target,
                                                const gl_float* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord2i(gl_enum target, gl_int s,
                                               gl_int t);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord2iv(gl_enum       target,
                                                const gl_int* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord2s(gl_enum target, gl_short s,
                                               gl_short t);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord2sv(gl_enum         target,
                                                const gl_short* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord3d(gl_enum target, gl_double s,
                                               gl_double t, gl_double r);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord3dv(gl_enum          target,
                                                const gl_double* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord3f(gl_enum target, gl_float s,
                                               gl_float t, gl_float r);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord3fv(gl_enum         target,
                                                const gl_float* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord3i(gl_enum target, gl_int s,
                                               gl_int t, gl_int r);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord3iv(gl_enum       target,
                                                const gl_int* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord3s(gl_enum target, gl_short s,
                                               gl_short t, gl_short r);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord3sv(gl_enum         target,
                                                const gl_short* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord4d(gl_enum target, gl_double s,
                                               gl_double t, gl_double r,
                                               gl_double q);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord4dv(gl_enum          target,
                                                const gl_double* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord4f(gl_enum target, gl_float s,
                                               gl_float t, gl_float r,
                                               gl_float q);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord4fv(gl_enum         target,
                                                const gl_float* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord4i(gl_enum target, gl_int s,
                                               gl_int t, gl_int r, gl_int q);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord4iv(gl_enum       target,
                                                const gl_int* v);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord4s(gl_enum target, gl_short s,
                                               gl_short t, gl_short r,
                                               gl_short q);
ZI_GLAPI void ZI_GLAPI_ENTRY glMultiTexCoord4sv(gl_enum         target,
                                                const gl_short* v);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glSampleCoverage(gl_clampf  value,
                                              gl_boolean invert);

// typedef void (APIENTRYP PFNgl_ACTIVETEXTUREPROC) (gl_enum texture);
// typedef void (APIENTRYP PFNgl_SAMPLECOVERAGEPROC) (gl_clampf value,
// gl_boolean invert); typedef void (APIENTRYP PFNgl_COMPRESSEDTEXIMAGE3DPROC)
// (gl_enum target, gl_int level, gl_enum internalformat, gl_sizei width,
// gl_sizei height, gl_sizei depth, gl_int border, gl_sizei imageSize, const
// gl_void *data); typedef void (APIENTRYP PFNgl_COMPRESSEDTEXIMAGE2DPROC)
// (gl_enum target, gl_int level, gl_enum internalformat, gl_sizei width,
// gl_sizei height, gl_int border, gl_sizei imageSize, const gl_void *data);
// typedef void (APIENTRYP PFNgl_COMPRESSEDTEXIMAGE1DPROC) (gl_enum target,
// gl_int level, gl_enum internalformat, gl_sizei width, gl_int border, gl_sizei
// imageSize, const gl_void *data); typedef void (APIENTRYP
// PFNgl_COMPRESSEDTEXSUBIMAGE3DPROC) (gl_enum target, gl_int level, gl_int
// xoffset, gl_int yoffset, gl_int zoffset, gl_sizei width, gl_sizei height,
// gl_sizei depth, gl_enum format, gl_sizei imageSize, const gl_void *data);
// typedef void (APIENTRYP PFNgl_COMPRESSEDTEXSUBIMAGE2DPROC) (gl_enum target,
// gl_int level, gl_int xoffset, gl_int yoffset, gl_sizei width, gl_sizei
// height, gl_enum format, gl_sizei imageSize, const gl_void *data); typedef
// void (APIENTRYP PFNgl_COMPRESSEDTEXSUBIMAGE1DPROC) (gl_enum target, gl_int
// level, gl_int xoffset, gl_sizei width, gl_enum format, gl_sizei imageSize,
// const gl_void *data); typedef void (APIENTRYP
// PFNgl_GETCOMPRESSEDTEXIMAGEPROC) (gl_enum target, gl_int level, gl_void
// *img);
