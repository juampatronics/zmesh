...
ZI_GLAPI void ZI_GLAPI_ENTRY glColorTable(gl_enum  target,
                                          gl_enum  internalformat,
                                          gl_sizei width, gl_enum format,
                                          gl_enum type, const gl_void* table);
ZI_GLAPI void ZI_GLAPI_ENTRY glColorSubTable(gl_enum target, gl_sizei start,
                                             gl_sizei count, gl_enum format,
                                             gl_enum type, const gl_void* data);
ZI_GLAPI void ZI_GLAPI_ENTRY glColorTableParameteriv(gl_enum       target,
                                                     gl_enum       pname,
                                                     const gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glColorTableParameterfv(gl_enum         target,
                                                     gl_enum         pname,
                                                     const gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glCopyColorSubTable(gl_enum target, gl_sizei start,
                                                 gl_int x, gl_int y,
                                                 gl_sizei width);
ZI_GLAPI void ZI_GLAPI_ENTRY glCopyColorTable(gl_enum target,
                                              gl_enum internalformat, gl_int x,
                                              gl_int y, gl_sizei width);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetColorTable(gl_enum target, gl_enum format,
                                             gl_enum type, gl_void* table);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetColorTableParameterfv(gl_enum   target,
                                                        gl_enum   pname,
                                                        gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetColorTableParameteriv(gl_enum target,
                                                        gl_enum pname,
                                                        gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glBlendEquation(gl_enum mode);
ZI_GLAPI void ZI_GLAPI_ENTRY glBlendColor(gl_clampf red, gl_clampf green,
                                          gl_clampf blue, gl_clampf alpha);
ZI_GLAPI void ZI_GLAPI_ENTRY glHistogram(gl_enum target, gl_sizei width,
                                         gl_enum    internalformat,
                                         gl_boolean sink);
ZI_GLAPI void ZI_GLAPI_ENTRY glResetHistogram(gl_enum target);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetHistogram(gl_enum target, gl_boolean reset,
                                            gl_enum format, gl_enum type,
                                            gl_void* values);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetHistogramParameterfv(gl_enum   target,
                                                       gl_enum   pname,
                                                       gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetHistogramParameteriv(gl_enum target,
                                                       gl_enum pname,
                                                       gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glMinmax(gl_enum target, gl_enum internalformat,
                                      gl_boolean sink);
ZI_GLAPI void ZI_GLAPI_ENTRY glResetMinmax(gl_enum target);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetMinmax(gl_enum target, gl_boolean reset,
                                         gl_enum format, gl_enum types,
                                         gl_void* values);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetMinmaxParameterfv(gl_enum   target,
                                                    gl_enum   pname,
                                                    gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetMinmaxParameteriv(gl_enum target,
                                                    gl_enum pname,
                                                    gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glConvolutionFilter1D(gl_enum  target,
                                                   gl_enum  internalformat,
                                                   gl_sizei width,
                                                   gl_enum format, gl_enum type,
                                                   const gl_void* image);
ZI_GLAPI void ZI_GLAPI_ENTRY glConvolutionFilter2D(
    gl_enum target, gl_enum internalformat, gl_sizei width, gl_sizei height,
    gl_enum format, gl_enum type, const gl_void* image);
ZI_GLAPI void ZI_GLAPI_ENTRY glConvolutionParameterf(gl_enum  target,
                                                     gl_enum  pname,
                                                     gl_float params);
ZI_GLAPI void ZI_GLAPI_ENTRY glConvolutionParameterfv(gl_enum         target,
                                                      gl_enum         pname,
                                                      const gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glConvolutionParameteri(gl_enum target,
                                                     gl_enum pname,
                                                     gl_int  params);
ZI_GLAPI void ZI_GLAPI_ENTRY glConvolutionParameteriv(gl_enum       target,
                                                      gl_enum       pname,
                                                      const gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glCopyConvolutionFilter1D(gl_enum target,
                                                       gl_enum internalformat,
                                                       gl_int x, gl_int y,
                                                       gl_sizei width);
ZI_GLAPI void ZI_GLAPI_ENTRY glCopyConvolutionFilter2D(gl_enum target,
                                                       gl_enum internalformat,
                                                       gl_int x, gl_int y,
                                                       gl_sizei width,
                                                       gl_sizei height);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetConvolutionFilter(gl_enum  target,
                                                    gl_enum  format,
                                                    gl_enum  type,
                                                    gl_void* image);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetConvolutionParameterfv(gl_enum   target,
                                                         gl_enum   pname,
                                                         gl_float* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetConvolutionParameteriv(gl_enum target,
                                                         gl_enum pname,
                                                         gl_int* params);
ZI_GLAPI void ZI_GLAPI_ENTRY glSeparableFilter2D(
    gl_enum target, gl_enum internalformat, gl_sizei width, gl_sizei height,
    gl_enum format, gl_enum type, const gl_void* row, const gl_void* column);
ZI_GLAPI void ZI_GLAPI_ENTRY glGetSeparableFilter(gl_enum target,
                                                  gl_enum format, gl_enum type,
                                                  gl_void* row, gl_void* column,
                                                  gl_void* span);

// typedef void (APIENTRYP PFNgl_BLENDCOLORPROC) (gl_clampf red, gl_clampf
// green, gl_clampf blue, gl_clampf alpha); typedef void (APIENTRYP
// PFNgl_BLENDEQUATIONPROC) (gl_enum mode);
