...
ZI_GLAPI gl_int ZI_GLAPI_ENTRY gluBuild1DMipmapLevels(
    gl_enum target, gl_int internalFormat, gl_sizei width, gl_enum format,
    gl_enum type, gl_int level, gl_int base, gl_int max, const void* data);
ZI_GLAPI gl_int ZI_GLAPI_ENTRY gluBuild1DMipmaps(gl_enum  target,
                                                 gl_int   internalFormat,
                                                 gl_sizei width, gl_enum format,
                                                 gl_enum     type,
                                                 const void* data);
ZI_GLAPI gl_int ZI_GLAPI_ENTRY
gluBuild2DMipmapLevels(gl_enum target, gl_int internalFormat, gl_sizei width,
                       gl_sizei height, gl_enum format, gl_enum type,
                       gl_int level, gl_int base, gl_int max, const void* data);
ZI_GLAPI gl_int ZI_GLAPI_ENTRY gluBuild2DMipmaps(
    gl_enum target, gl_int internalFormat, gl_sizei width, gl_sizei height,
    gl_enum format, gl_enum type, const void* data);
ZI_GLAPI gl_int ZI_GLAPI_ENTRY gluBuild3DMipmapLevels(
    gl_enum target, gl_int internalFormat, gl_sizei width, gl_sizei height,
    gl_sizei depth, gl_enum format, gl_enum type, gl_int level, gl_int base,
    gl_int max, const void* data);
ZI_GLAPI gl_int ZI_GLAPI_ENTRY gluBuild3DMipmaps(
    gl_enum target, gl_int internalFormat, gl_sizei width, gl_sizei height,
    gl_sizei depth, gl_enum format, gl_enum type, const void* data);
ZI_GLAPI gl_boolean ZI_GLAPI_ENTRY gluCheckExtension(const gl_ubyte* extName,
                                                     const gl_ubyte* extString);
ZI_GLAPI void ZI_GLAPI_ENTRY gluCylinder(::GLUquadric* quad, gl_double base,
                                         gl_double top, gl_double height,
                                         gl_int slices, gl_int stacks);
...
ZI_GLAPI void ZI_GLAPI_ENTRY gluDisk(::GLUquadric* quad, gl_double inner,
                                     gl_double outer, gl_int slices,
                                     gl_int loops);
...
ZI_GLAPI void ZI_GLAPI_ENTRY            gluGetNurbsProperty(::GLUnurbs* nurb,
                                                            gl_enum     property,
                                                            gl_float*   data);
ZI_GLAPI const gl_ubyte* ZI_GLAPI_ENTRY gluGetString(gl_enum name);
ZI_GLAPI void ZI_GLAPI_ENTRY gluGetTessProperty(::GLUtesselator* tess,
                                                gl_enum which, gl_double* data);
ZI_GLAPI void ZI_GLAPI_ENTRY
gluLoadSamplingMatrices(::GLUnurbs* nurb, const gl_float* model,
                        const gl_float* perspective, const gl_int* view);
ZI_GLAPI void ZI_GLAPI_ENTRY gluLookAt(gl_double eyeX, gl_double eyeY,
                                       gl_double eyeZ, gl_double centerX,
                                       gl_double centerY, gl_double centerZ,
                                       gl_double upX, gl_double upY,
                                       gl_double upZ);
...
ZI_GLAPI void ZI_GLAPI_ENTRY             gluNextContour(::GLUtesselator* tess,
                                                        gl_enum          type);
// ZI_GLAPI void ZI_GLAPI_ENTRY gluNurbsCallback (::GLUnurbs* nurb, gl_enum
// which, _::GLUfuncptr CallBackFunc);
ZI_GLAPI void ZI_GLAPI_ENTRY gluNurbsCallbackData(::GLUnurbs* nurb,
                                                  gl_void*    userData);
ZI_GLAPI void ZI_GLAPI_ENTRY gluNurbsCallbackDataEXT(::GLUnurbs* nurb,
                                                     gl_void*    userData);
ZI_GLAPI void ZI_GLAPI_ENTRY gluNurbsCurve(::GLUnurbs* nurb, gl_int knotCount,
                                           gl_float* knots, gl_int stride,
                                           gl_float* control, gl_int order,
                                           gl_enum type);
ZI_GLAPI void ZI_GLAPI_ENTRY gluNurbsProperty(::GLUnurbs* nurb,
                                              gl_enum property, gl_float value);
ZI_GLAPI void ZI_GLAPI_ENTRY gluNurbsSurface(
    ::GLUnurbs* nurb, gl_int sKnotCount, gl_float* sKnots, gl_int tKnotCount,
    gl_float* tKnots, gl_int sStride, gl_int tStride, gl_float* control,
    gl_int sOrder, gl_int tOrder, gl_enum type);
ZI_GLAPI void ZI_GLAPI_ENTRY gluOrtho2D(gl_double left, gl_double right,
                                        gl_double bottom, gl_double top);
ZI_GLAPI void ZI_GLAPI_ENTRY gluPartialDisk(::GLUquadric* quad, gl_double inner,
                                            gl_double outer, gl_int slices,
                                            gl_int loops, gl_double start,
                                            gl_double sweep);
ZI_GLAPI void ZI_GLAPI_ENTRY gluPerspective(gl_double fovy, gl_double aspect,
                                            gl_double zNear, gl_double zFar);
ZI_GLAPI void ZI_GLAPI_ENTRY gluPickMatrix(gl_double x, gl_double y,
                                           gl_double delX, gl_double delY,
                                           gl_int* viewport);
ZI_GLAPI gl_int ZI_GLAPI_ENTRY gluProject(gl_double objX, gl_double objY,
                                          gl_double        objZ,
                                          const gl_double* model,
                                          const gl_double* proj,
                                          const gl_int* view, gl_double* winX,
                                          gl_double* winY, gl_double* winZ);
ZI_GLAPI void ZI_GLAPI_ENTRY   gluPwlCurve(::GLUnurbs* nurb, gl_int count,
                                           gl_float* data, gl_int stride,
                                           gl_enum type);
// ZI_GLAPI void ZI_GLAPI_ENTRY gluQuadricCallback (::GLUquadric* quad, gl_enum
// which, _::GLUfuncptr CallBackFunc);
ZI_GLAPI void ZI_GLAPI_ENTRY   gluQuadricDrawStyle(::GLUquadric* quad,
                                                   gl_enum       draw);
ZI_GLAPI void ZI_GLAPI_ENTRY   gluQuadricNormals(::GLUquadric* quad,
                                                 gl_enum       normal);
ZI_GLAPI void ZI_GLAPI_ENTRY   gluQuadricOrientation(::GLUquadric* quad,
                                                     gl_enum       orientation);
ZI_GLAPI void ZI_GLAPI_ENTRY   gluQuadricTexture(::GLUquadric* quad,
                                                 gl_boolean    texture);
ZI_GLAPI gl_int ZI_GLAPI_ENTRY gluScaleImage(gl_enum format, gl_sizei wIn,
                                             gl_sizei hIn, gl_enum typeIn,
                                             const void* dataIn, gl_sizei wOut,
                                             gl_sizei hOut, gl_enum typeOut,
                                             gl_void* dataOut);
ZI_GLAPI void ZI_GLAPI_ENTRY   gluSphere(::GLUquadric* quad, gl_double radius,
                                         gl_int slices, gl_int stacks);
ZI_GLAPI void ZI_GLAPI_ENTRY   gluTessBeginContour(::GLUtesselator* tess);
ZI_GLAPI void ZI_GLAPI_ENTRY   gluTessBeginPolygon(::GLUtesselator* tess,
                                                   gl_void*         data);
// ZI_GLAPI void ZI_GLAPI_ENTRY gluTessCallback (::GLUtesselator* tess, gl_enum
// which, _::GLUfuncptr CallBackFunc);
...
ZI_GLAPI void ZI_GLAPI_ENTRY gluTessNormal(::GLUtesselator* tess,
                                           gl_double valueX, gl_double valueY,
                                           gl_double valueZ);
ZI_GLAPI void ZI_GLAPI_ENTRY gluTessProperty(::GLUtesselator* tess,
                                             gl_enum which, gl_double data);
ZI_GLAPI void ZI_GLAPI_ENTRY gluTessVertex(::GLUtesselator* tess,
                                           gl_double* location, gl_void* data);
ZI_GLAPI gl_int ZI_GLAPI_ENTRY gluUnProject(gl_double winX, gl_double winY,
                                            gl_double        winZ,
                                            const gl_double* model,
                                            const gl_double* proj,
                                            const gl_int* view, gl_double* objX,
                                            gl_double* objY, gl_double* objZ);
ZI_GLAPI gl_int ZI_GLAPI_ENTRY
gluUnProject4(gl_double winX, gl_double winY, gl_double winZ, gl_double clipW,
              const gl_double* model, const gl_double* proj, const gl_int* view,
              gl_double nearVal, gl_double farVal, gl_double* objX,
              gl_double* objY, gl_double* objZ, gl_double* objW);
