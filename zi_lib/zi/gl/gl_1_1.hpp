...
ZI_GLAPI void ZI_GLAPI_ENTRY glVertexPointer(gl_int size, gl_enum type,
                                             gl_sizei       stride,
                                             const gl_void* ptr);
ZI_GLAPI void ZI_GLAPI_ENTRY glNormalPointer(gl_enum type, gl_sizei stride,
                                             const gl_void* ptr);
ZI_GLAPI void ZI_GLAPI_ENTRY glColorPointer(gl_int size, gl_enum type,
                                            gl_sizei       stride,
                                            const gl_void* ptr);
ZI_GLAPI void ZI_GLAPI_ENTRY glIndexPointer(gl_enum type, gl_sizei stride,
                                            const gl_void* ptr);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexCoordPointer(gl_int size, gl_enum type,
                                               gl_sizei       stride,
                                               const gl_void* ptr);
ZI_GLAPI void ZI_GLAPI_ENTRY glEdgeFlagPointer(gl_sizei       stride,
                                               const gl_void* ptr);
...
ZI_GLAPI void ZI_GLAPI_ENTRY glDrawArrays(gl_enum mode, gl_int first,
                                          gl_sizei count);
ZI_GLAPI void ZI_GLAPI_ENTRY glDrawElements(gl_enum mode, gl_sizei count,
                                            gl_enum        type,
                                            const gl_void* indices);
ZI_GLAPI void ZI_GLAPI_ENTRY glInterleavedArrays(gl_enum        format,
                                                 gl_sizei       stride,
...
ZI_GLAPI void ZI_GLAPI_ENTRY glDeleteTextures(gl_sizei       n,
                                              const gl_uint* textures);
ZI_GLAPI void ZI_GLAPI_ENTRY glBindTexture(gl_enum target, gl_uint texture);
ZI_GLAPI void ZI_GLAPI_ENTRY glPrioritizeTextures(gl_sizei         n,
                                                  const gl_uint*   textures,
                                                  const gl_clampf* priorities);
ZI_GLAPI gl_boolean ZI_GLAPI_ENTRY glAreTexturesResident(
    gl_sizei n, const gl_uint* textures, gl_boolean* residences);
ZI_GLAPI gl_boolean ZI_GLAPI_ENTRY glIsTexture(gl_uint texture);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexSubImage1D(gl_enum target, gl_int level,
                                             gl_int xoffset, gl_sizei width,
                                             gl_enum format, gl_enum type,
                                             const gl_void* pixels);
ZI_GLAPI void ZI_GLAPI_ENTRY glTexSubImage2D(gl_enum target, gl_int level,
                                             gl_int xoffset, gl_int yoffset,
                                             gl_sizei width, gl_sizei height,
                                             gl_enum format, gl_enum type,
                                             const gl_void* pixels);
ZI_GLAPI void ZI_GLAPI_ENTRY glCopyTexImage1D(gl_enum target, gl_int level,
                                              gl_enum internalformat, gl_int x,
                                              gl_int y, gl_sizei width,
                                              gl_int border);
ZI_GLAPI void ZI_GLAPI_ENTRY glCopyTexImage2D(gl_enum target, gl_int level,
                                              gl_enum internalformat, gl_int x,
                                              gl_int y, gl_sizei width,
                                              gl_sizei height, gl_int border);
ZI_GLAPI void ZI_GLAPI_ENTRY glCopyTexSubImage1D(gl_enum target, gl_int level,
                                                 gl_int xoffset, gl_int x,
                                                 gl_int y, gl_sizei width);
ZI_GLAPI void ZI_GLAPI_ENTRY glCopyTexSubImage2D(gl_enum target, gl_int level,
                                                 gl_int xoffset, gl_int yoffset,
                                                 gl_int x, gl_int y,
                                                 gl_sizei width,
                                                 gl_sizei height);
