...
private:
    ...
    typedef multi_index_container<
        entry_t, multi_index::indexed_by<
                     multi_index::hashed_unique<multi_index::tag<token_tag>,
                                                MULTI_INDEX_MEMBER(
                                                    entry_t, int64_t, token_)>,
    ...
    typedef
        typename index_t::template index<timestamp_tag>::type timestamp_index_t;
