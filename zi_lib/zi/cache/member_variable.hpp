...
template <class CachedType, class Type, Type CachedType::* MemberVariablePtr>
struct non_const_member
{
    ...
    Type& operator()(CachedType& v) const { return v.*MemberVariablePtr; }
...
struct const_member
{
    ...
    Type& operator()(const CachedType& v) const { return v.*MemberVariablePtr; }
...
struct member_variable
    : detail::if_<
          ...
          member_variable_::non_const_member<CachedType, Type,
