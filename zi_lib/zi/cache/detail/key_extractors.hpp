...
struct extract_type: if_t< is_reference< Class >,
                           extract_type< typename remove_reference< Class
>::type > if_t< is_const< Class >, extract_type< typename remove_const< Class
>::type >, if_t<
...
template <class Type>
static char tester(typename Type::key_t*);
template <class Type>
static int tester(...);
...
struct has_key_t_checker
{
    static const bool value =
        (sizeof(has_key_t_checker_::tester<
                typename remove_pointer<typename remove_all_extents<
                    typename remove_cv<typename remove_reference<Class>::type>::
                        type>::type>::type>(0)) == 1);
};
