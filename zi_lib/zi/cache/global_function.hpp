...
template <class CachedType, class Result,
...
struct non_ref
{
    ...
    Result operator()(
        const reference_wrapper<typename remove_const<CachedType>::type>& v_ref,
        void* = 0) const
    {
        return this->operator()(v_ref.get());
    }
...
struct non_const_ref
{
    ...
    template <class PtrToCachedType>
    typename disable_if<
        is_convertible<PtrToCachedType&, CachedType>::type::value, Result>::type
    operator()(const PtrToCachedType& ptr) const
    {
        return this->operator()(*ptr);
    }

    Result operator()(CachedType v) const { return StaticFunctionPtr(v); }

    Result operator()(
        const reference_wrapper<typename remove_reference<CachedType>::type>&
            v_ref) const
    {
        return this->operator()(v_ref.get());
    }
...
struct const_ref
{
    ...
    template <class PtrToCachedType>
    typename disable_if<
        is_convertible<const PtrToCachedType&, CachedType>::type::value,
        Result>::type
    operator()(const PtrToCachedType& ptr) const
    {
        return this->operator()(*ptr);
    ...
    operator()(const reference_wrapper<typename remove_const<
                   typename remove_reference<CachedType>::type>::type>& v_ref,
               void* = 0) const
    {
        return this->operator()(v_ref.get());
    }
...
struct global_function
    : detail::if_<
          ...
          typename detail::if_<
              ...
              global_function_::const_ref<CachedType, Result,
                                          StaticFunctionPtr>,
              global_function_::non_const_ref<CachedType, Result,
                                              StaticFunctionPtr>>::type,
          global_function_::non_ref<CachedType, Result,
                                    StaticFunctionPtr>>::type
{
};
