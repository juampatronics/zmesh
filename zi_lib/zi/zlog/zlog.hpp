...
{
    ZiLOGGING_call() { std::ios_base::sync_with_stdio(false); }
};
...
#    define ZiLOGGING_DEFAULT()                                                \
        ZiLOGGING_CALL_ONCE_NICE_ERROR() static ::zi::zlog::ZiLOGGING_call     \
            ____ZiLOGGING_called_here____

#    define ZiLOGGING_STDOUT()                                                 \
        ZiLOGGING_CALL_ONCE_NICE_ERROR() static ::zi::zlog::log_sinks::        \
            all_cout_initializer          ___zlog_init___;                     \
        static ::zi::zlog::ZiLOGGING_call ____ZiLOGGING_called_here____

#    define ZiLOGGING_STDERR()                                                 \
        ZiLOGGING_CALL_ONCE_NICE_ERROR() static ::zi::zlog::log_sinks::        \
            all_cerr_initializer          ___zlog_init___;                     \
        static ::zi::zlog::ZiLOGGING_call ____ZiLOGGING_called_here____

#    define ZiLOGGING_STDLOG()                                                 \
        ZiLOGGING_CALL_ONCE_NICE_ERROR() static ::zi::zlog::log_sinks::        \
            all_clog_initializer          ___zlog_init___;                     \
        static ::zi::zlog::ZiLOGGING_call ____ZiLOGGING_called_here____

#    define ZiLOGGING_FILES()                                                  \
        ZiLOGGING_CALL_ONCE_NICE_ERROR() static ::zi::zlog::log_sinks::        \
            file_initializer              ____zlog_init____;                   \
        static ::zi::zlog::ZiLOGGING_call ____ZiLOGGING_called_here____
...
#    define ZiLOG_DEBUG_IMPL(name, ...)                                        \
        IF_ZiLOG_IMPL(name)::zi::zlog::token_wrapper(                          \
            *::zi::zlog::log_sinks_.debug_)                                    \
                .get()                                                         \
...
#    define ZiLOG_WARNING_IMPL(name, ...)                                      \
        IF_ZiLOG_IMPL(name)::zi::zlog::token_wrapper(                          \
            *::zi::zlog::log_sinks_.warning_)                                  \
                .get()                                                         \
            << "WARNING" << "(" name ")"                                       \
            << ::zi::zlog::log_printf(__VA_ARGS__)
