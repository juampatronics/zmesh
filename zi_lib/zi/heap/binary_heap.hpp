...
struct hashed_index
{
    ...
    typedef robin_hood::unordered_flat_map<key_type, uint32_t, Hash, Pred>
        container_type;
};
...
struct binary_heap
    : ::zi::heap::detail::binary_heap_impl<
          Type, typename IndexTraits::key_type,
          typename ValueTraits::value_type, typename IndexTraits::key_extractor,
          typename ValueTraits::value_extractor,
          typename ValueTraits::compare_type,
          typename IndexTraits::container_type, Allocator>
{
private:
    ...
    typedef ::zi::heap::detail::binary_heap_impl<
        Type, typename IndexTraits::key_type, typename ValueTraits::value_type,
