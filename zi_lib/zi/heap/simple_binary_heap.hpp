...
template <class Heapable, class Compare = std::less<Heapable>,
          class Hash = hash<Heapable>, class Pred = std::equal_to<Heapable>,
...
private:
    typedef typename allocator_type::template rebind<
        std::pair<const Heapable, std::size_t>>::other hash_map_alloc;

    typedef unordered_map<Heapable, std::size_t, Hash, Pred, hash_map_alloc>
                                         hash_map_type;
