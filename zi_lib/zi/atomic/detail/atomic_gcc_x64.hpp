...
inline atomic_word compare_swap(volatile atomic_word* ptr, atomic_word asgn,
                                atomic_word cmp)
{
    atomic_word old = cmp;
    asm volatile("lock\n\t"
...
inline void write(atomic_word* ptr, atomic_word val) { *ptr = val; }

inline atomic_word read(atomic_word* ptr) { return *ptr; }
