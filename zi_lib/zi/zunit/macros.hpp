        ...
        {                                                                      \
            ...
            {                                                                  \
                ::zi::zunit::test_suite_tpl<                                   \
                    typename ::zi::zunit::suite_tag<FileTag>::tag>::instance() \
                    .add_test(*this);                                          \
            }                                                                  \
                                                                               \
...
#    define ZiSUITE(_name)                                                     \
        ...
        struct suite_##_name##_tag;                                            \
                                                                               \
        template <>                                                            \
        struct suite_tag<this_file_tag>                                        \
        {                                                                      \
            typedef suite_##_name##_tag tag;                                   \
        };                                                                     \
                                                                               \
        template <>                                                            \
        struct suite_name<suite_##_name##_tag>                                 \
        {                                                                      \
        ...
        static ::zi::zunit::test_suite& ___suite_instance(                     \
            ::zi::zunit::test_suite_tpl<                                       \
                ::zi::zunit::suite_##_name##_tag>::instance())

#    define ZiRUN_ALL_TESTS() ::zi::zunit::registry::instance().run_all()
