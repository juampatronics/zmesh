...
public:
    ...
    virtual operator bool() const { return passed_; }
};
...
{
public:
    unary_check_exception(const std::string& check, const std::string& arg,
                          const std::string& arg_value,
                          const std::string& arg_type, test_case* test,
                          int line)
...
{
public:
    binary_check_exception(const std::string& check, const std::string& larg,
                           const std::string& rarg, const std::string& lval,
                           const std::string& rval, const std::string& ltpe,
                           const std::string& rtpe, test_case* test, int line)
    ...
    const char* arg_value(int i) const
    {
        return i ? rval_.c_str() : lval_.c_str();
    }
    const char* arg_type(int i) const
    {
        return i ? rtpe_.c_str() : ltpe_.c_str();
    }
...
public:
    throw_check_exception(const std::string& check, const std::string& what,
                          const char* larg, const char* rarg, test_case* test,
                          int line)
