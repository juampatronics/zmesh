        ...
        {                                                                      \
            ...
            {                                                                  \
                throw ::zi::zunit::unary_check_exception(                      \
                    "EXPECT_" #op, #v, ___c.value_, ___c.type_, this,          \
                    __LINE__);                                                 \
            }                                                                  \
        } while (0)
        ...
        {                                                                      \
            ...
            {                                                                  \
                throw ::zi::zunit::binary_check_exception(                     \
                    "EXPECT_" #op, #l, #r, ___c.lvalue_, ___c.rvalue_,         \
                    ___c.ltype_, ___c.rtype_, this, __LINE__);                 \
            }                                                                  \
        } while (0)
...
#    define ZI_EXPECT_THROW_XXX(v, e)                                          \
        {                                                                      \
            ...
            {                                                                  \
                throw ::zi::zunit::throw_check_exception(                      \
                    "EXPECT_THROW", "Unknown exception", #v, #e, this,         \
                    __LINE__);                                                 \
            }                                                                  \
                                                                               \
            if (!___ok)                                                        \
