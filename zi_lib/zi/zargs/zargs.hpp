...
#    define ZiARG_DEFINITION(_name, _default, _desc, _type, _type_str)         \
        ...
        {                                                                      \
            ...
            class arg_handler_##_name : public zi::zargs_::arguments::handler  \
            {                                                                  \
            private:                                                           \
            ...
            public:                                                            \
                arg_handler_##_name()                                          \
                {                                                              \
                    zi::zargs_::arguments::instance().register_handler(this);  \
                }                                                              \
                                                                               \
                std::string get_name() const { return #_name; }                \
                std::string get_type() const { return #_type_str; }            \
                std::string get_default() const { return #_default; }          \
...
#    define ZIARG_SET_DEF(_name, _type, _types, _desc)                         \
        ZiARG_DEFINITION(_name, std::set<_type>(), _desc, std::set<_type>,     \
                         _types)
...
#    define ZIARG_LIST_DEF(_name, _type, _types, _desc)                        \
        ZiARG_DEFINITION(_name, std::vector<_type>(), _desc,                   \
                         std::vector<_type>, _types)
...
#    define ZiARG_enabled(_name, _desc)                                        \
        ...
        ZiARG_DEFINITION(_name, property_map(), _desc, property_map,           \
                         STRING_LIST)
...
#    define __ZiARG_DECL_SET(_name, _type) __ZiARG_DECL(_name, std::set<_type>)
